  ...
  static Route<dynamic>? onGenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case testSeriesDetail:
        return page(TestSeriesDetailScreen(seriesId: settings.arguments! as int));
      case test:
...
extension AppNavigation on BuildContext {
  Future<T?> openCourse<T>(int courseId) =>
      Navigator.of(this).pushNamed<T>(Routes.courseOutline, arguments: courseId);

  Future<T?> openLesson<T>(int lessonId) =>
      Navigator.of(this).pushNamed<T>(Routes.lesson, arguments: lessonId);

  Future<T?> openSeries<T>(int seriesId) =>
      Navigator.of(this).pushNamed<T>(Routes.testSeriesDetail, arguments: seriesId);
  ...
  void replaceWithResult(int sessionId) =>
      Navigator.of(this).pushReplacementNamed(Routes.result, arguments: sessionId);
}
