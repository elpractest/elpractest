...
class WelcomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // The hero takes whatever the copy does not need, so the CTA is always
      // reachable — on a tall phone the hero reads as the guide's ~56% band, and
      // on a short or landscape viewport it simply yields rather than clipping
      // the headline or the buttons off the bottom.
      body: Column(
        children: [
